...
const ServiceDetails = () => {
  ...
  return (
    <>
      ...
      <div>
        {lodding && <Lodder />}
        <div  style={{ backgroundColor: "#436da7" }} className="font-sans md:pt-40   md:pb-20 pt-24 pb-10">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-4">
                  <button
                    ...
                    type="button"
                    className="min-w-[200px] px-4 py-3 bg-[#41B3A2] hover:bg-gray-900 text-white text-sm font-semibold rounded-md"
                  >
                    Book Service
                  </button>
                </div>
