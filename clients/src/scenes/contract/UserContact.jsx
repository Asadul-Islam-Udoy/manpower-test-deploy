...
import { ContractRefreshAction, SendMessageClientToAdminAction } from "../../action/auth_user/UserAction";
...
const UserContact = () => {
  ...
  return (
    <>
      <Header />
      <div style={{width:'100%'}} className="h-100 lg:w-38 md:h-full md:w-48 mt-8 md:mt-0  ">
        <section  style={{ backgroundColor: "#436da7" }} className="bg-blue-200 md:pt-24 dark:bg-slate-800" id="contact">
          <div className="mx-auto max-w-screen-xl  px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
            <div className="mb-4">
              <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
                ...
                <p className="mx-auto mt-4 max-w-3xl text-xl text-gray-50 dark:text-slate-400">
            ...
            <div className="flex items-stretch justify-center">
              <div className="grid md:grid-cols-2">
                <div className="h-full pr-6">
                  <p className="mt-3 mb-12 text-lg text-gray-50 dark:text-slate-400">
                  ...
                  <ul className="mb-6 md:mb-0">
                    <li className="flex">
                      <div className="flex h-10 w-10 items-center justify-center rounded  bg-[#41B3A2] text-gray-50">
                        <svg
                ...
                <div className="card h-fit max-w-6xl p-5 md:p-12" id="form">
                  ...
                  <form id="contactForm" onSubmit={handlerSubmit}>
                    ...
                    <div className="text-center">
                      <button
                        type="submit"
                        className="w-full  bg-[#41B3A2] text-white px-6 py-3 font-xl rounded-md sm:mb-0"
                      >
                        Send Message
                      </button>
                    </div>
