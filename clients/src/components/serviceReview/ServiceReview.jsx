  ...
  return (
    <div>
      <section className="bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
        <div className="mx-auto max-w-screen-xl px-4 2xl:px-0 m-5">
          ...
          <div className="my-6 gap-8 ml-9 sm:flex sm:items-start md:my-8">
            ...
            <div className="mt-6 min-w-0 flex-1 space-y-3 sm:mt-0">
              <div className="flex items-center gap-2">
                ...
                <div className="h-1.5 w-80 rounded-full bg-gray-200 dark:bg-gray-700">
                  <div style={{width:`${Five}%`}} className="h-1.5 rounded-full bg-yellow-300 "></div>
                </div>
                <a
                  href="#"
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="h-1.5 w-80 rounded-full bg-gray-200 dark:bg-gray-700">
                  <div style={{width:`${Four}`}} className="h-1.5 rounded-full bg-yellow-300 "></div>
                </div>
                <a
                  href="#"
                  className="w-8 shrink-0 text-right text-sm font-medium leading-none text-primary-700 hover:underline dark:text-primary-500 sm:w-auto sm:text-left"
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="h-1.5 w-80 rounded-full bg-gray-200 dark:bg-gray-700">
                  <div style={{width:`${Thire}%`}} className="h-1.5 rounded-full bg-yellow-300"></div>
                </div>
                <a
                  href="#"
                  className="w-8 shrink-0 text-right text-sm font-medium leading-none text-primary-700 hover:underline dark:text-primary-500 sm:w-auto sm:text-left"
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="h-1.5 w-80 rounded-full bg-gray-200 dark:bg-gray-700">
                  <div style={{width:`${Two}%`}}  className="h-1.5 rounded-full bg-yellow-300 "></div>
                </div>
                <a
                  href="#"
                  className="w-8 shrink-0 text-right text-sm font-medium leading-none text-primary-700 hover:underline dark:text-primary-500 sm:w-auto sm:text-left"
              ...
              <div className="flex items-center gap-2">
                ...
                <div className="h-1.5 w-80 rounded-full bg-gray-200 dark:bg-gray-700">
                  <div style={{width:`${One}%`}} className="h-1.5 rounded-full bg-yellow-300"></div>
                </div>
                <a
                  href="#"
                  className="w-8 shrink-0 text-right text-sm font-medium leading-none text-primary-700 hover:underline dark:text-primary-500 sm:w-auto sm:text-left"
          ...
          {singleService?.reviews.slice(0, addReviwList).map((i) => (
            <div className="mt-6 divide-y divide-gray-200 ml-8 dark:divide-gray-700">
              <div className="gap-3 pb-6 sm:flex sm:items-start pt-10">
          ...
          <div className="mt-6 text-center">
            <button
              ...
              className="mb-2 me-2 rounded-lg border border-gray-200 bg-[#41B3A2] text-white px-5 py-2.5 text-sm font-medium hover:bg-gray-100 hover:text-gray-900 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100"
            >
              View more reviews
            </button>
          </div>
