      ...
      <footer className="max-w-screen-xl mx-auto w-full text-slate-400">
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-8 lg:grid-cols-12">
              ...
              >
                ...
                <ul>
                  ...
                  <li className="mb-2 leading-6">
                    <h1 className="text-green-500 text-md">Radisson Digital Technologies Ltd.</h1>
                    <a
                      href="javascript:void(0)"
                      className="transition-colors duration-300 hover:text-emerald-500 focus:text-emerald-600"
                    >
              ...
              >
                ...
                <ul>
                  ...
                  <li className="mt-4 md:flex contents gap-5 mr-20">
                    <img className="pb-5 w-[60%]" src="/images/app-store.png" alt="app image" />
                    <img className="pb-5 w-[60%]" src="/images/play-store.png" alt="play store image" />
                  </li>
                  <nav
        ...
        <div className="py-4 text-sm border-t border-slate-700">
          <div className="text-center">
            Copyright © 2024 <span className="text-emerald-500">Radisson Web Team </span> | All Rights
            Reserved
          </div>
        </div>
        </div>
