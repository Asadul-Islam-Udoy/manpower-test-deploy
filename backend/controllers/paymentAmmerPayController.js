...
exports.createPaymentControler = async (req, res) => {
  try {
    ...
    console.log('workersItems',workersItems)
...
exports.successPaymentControler = async (req, res) => {
  ...
  res.redirect(`${req.protocol}://${req.get("host")}/user/payment/success`);
};
...
exports.failPaymentControler = async (req, res) => {
  ...
  res.redirect(`${req.protocol}://${req.get("host")}/user/payment/fails`);
};
...
exports.cancelPaymentControler = async (req, res) => {
  ...
  res.redirect(`${req.protocol}://${req.get("host")}/user/payment/cancel`); 
};
